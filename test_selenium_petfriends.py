...
def test_show_all_pets():
   # Вводим email
   driver.find_element(By.ID, 'email').send_keys('frolov999@yandex.ru')
   # Вводим пароль
...
def test_show_my_pets():
   ...
   # Ожидаем в течение 5с, что на странице есть тег h2 с текстом "User1234" -именем пользователя
   assert wait.until(EC.text_to_be_present_in_element((By.TAG_NAME, 'h2'), "User1234"))
